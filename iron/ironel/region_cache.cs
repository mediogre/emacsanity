namespace IronElisp
{
    ...
    public class region_cache
    {
        ...
        /* The areas that haven't changed since the last time we cleaned out
           ...
           entirely unchanged.  */
        public int beg_unchanged, end_unchanged;
        ...
        public int buffer_beg, buffer_end;
    }

    public partial class L
    {
        /* How many elements to add to the gap when we resize the buffer.  */
        public const int NEW_CACHE_GAP = 40;
        ...
        public const int PRESERVE_THRESHOLD = 500;

        /* Return the position of boundary i in cache c.  */
        public static int BOUNDARY_POS(region_cache c, int i)
        {
            return ((i) < c.gap_start 
   ...
   : c.buffer_end + c.boundaries[c.gap_len + i].pos);
        ...
        public static int BOUNDARY_VALUE(region_cache c, int i) 
        {
  return (i < c.gap_start 
   ...
   : c.boundaries[c.gap_len + i].value);
        ...
        public static void SET_BOUNDARY_VALUE(region_cache c, int i, int v) 
        {
            if (i < c.gap_start)
        ...
        public static region_cache new_region_cache()
        {
            region_cache c = new region_cache();

            c.gap_start = 0;
            c.gap_len = NEW_CACHE_GAP;
            c.cache_len = 0;
            c.boundaries = new boundary[c.gap_len + c.cache_len];
        ...
        public static void free_region_cache(region_cache c)
        {
            // xfree (c->boundaries);
            // xfree (c);
        }
        ...
        public static int find_cache_boundary(region_cache c, int pos)
        {
        ...
        public static void move_cache_gap(region_cache c, int pos, int min_size)
        {
            ...
            if (gap_len < min_size)
            {
                ...
                System.Array.Resize(ref c.boundaries, (min_size + c.cache_len));
        ...
        public static void insert_cache_boundary(region_cache c, int index, int pos, int value)
        {
        ...
        public static void delete_cache_boundaries(region_cache c, int start, int end)
        {
            int len = end - start;
        ...
        public static void set_cache_region(region_cache c, int start, int end, int value)
        {
            if (start > end)
                abort();
        ...
        public static void invalidate_region_cache(Buffer buf, region_cache c, int head, int tail)
        {
        ...
        public static void revalidate_region_cache(Buffer buf, region_cache c)
        {
        ...
        public static void know_region_cache(Buffer buf, region_cache c, int start, int end)
        {
            revalidate_region_cache(buf, c);
        ...
        public static int region_cache_forward(Buffer buf, region_cache c, int pos, bool has_next, ref int next)
        {
            revalidate_region_cache(buf, c);
        ...
        public static int region_cache_backward(Buffer buf, region_cache c, int pos, bool has_next, ref int next)
        {
            revalidate_region_cache(buf, c);
